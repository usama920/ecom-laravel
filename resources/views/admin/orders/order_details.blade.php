                            ...
                            <table id="table_id" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="taskStatus">Not Used</td>
                                        @else
                                    ...
                                    <tr>
                                        <td class="taskDesc">Payment Methos</td>
                        ...
                        <form action="{{url('/admin/update-order-status')}}" method="post">
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <select name="order_status" id="order_status" class="form-control">
                                            <option value="New" @if($orderDetails->order_status=="New") selected
                                                @endif>New</option>
                                            <option value="Pending" @if($orderDetails->order_status=="Pending") selected
                                                @endif>Pending</option>
                                            <option value="In Process" @if($orderDetails->order_status=="In Process")
                                                selected @endif>In Process</option>
                                            <option value="Shipped" @if($orderDetails->order_status=="Shipped") selected
                                    ...
                                    <td>
                                    <input type="submit" value="Update Status" class="btn btn-success btn-sm"></td>
                                </tr>
                            </table>
                        </form>
