    ...
    <div class="container">
        <div class="row">
                ...
                <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item {{$key==0 ? 'active' : ''}}"> <img class="d-block w-100"
                                src="{{asset('/uploads/products/'.$images->image)}}" alt="First slide"> </div>
                        @endforeach
                    </div>
            ...
            <div class="col-xl-7 col-lg-7 col-md-6">
                <form action="{{url('/add-cart')}}" name="addtoCart" method="POST">
                @csrf
                <div class="single-product-details">
                    ...
                    <h5 id="getPrice">Product Price : PKR {{$productDetails->price}}</h5>
